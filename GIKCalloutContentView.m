...
@property (nonatomic, strong) UIButton *rightAccessoryView;
...
+ (GIKCalloutContentView *)viewWithLabelText:(NSString *)text {
	...
	return [[self alloc] initWithFrame:contentFrame text:text textSize:textSize];
}
...
- (UIButton *)rightAccessoryView {
	if (rightAccessoryView == nil) {
		rightAccessoryView = [UIButton buttonWithType:UIButtonTypeCustom];
