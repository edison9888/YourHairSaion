...
@interface MainSplitViewController : MGSplitViewController<NGTabBarControllerDelegate, MGSplitViewControllerDelegate>

@property (nonatomic, strong)IBOutlet NGTabBarController* leftTabBarController;
@property (nonatomic, strong)IBOutlet NGTabBarController* rightTabBarController;
@end
