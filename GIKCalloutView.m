...
@property (weak, nonatomic, readonly) UIImageView *topLeft, *topMiddle, *middleMiddle, *topRight;
@property (weak, nonatomic, readonly) UIImageView *leftAboveArrow, *leftBelowArrow, *rightAboveArrow, *rightBelowArrow;
@property (weak, nonatomic, readonly) UIImageView *bottomLeft, *bottomLeftOfArrow, *bottomRightOfArrow, *bottomRight;
@property (nonatomic, strong) UIImageView *leftArrow, *rightArrow, *bottomArrow;
...
- (void)setCalloutContentView:(UIView *)theContentView {
	if (calloutContentView != theContentView) {
		...
		calloutContentView = theContentView;
